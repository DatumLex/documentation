...
This folder defines what DatumLex is, who it serves, which problems it addresses,
and how its product direction evolves. It complements the technical and process
documentation by providing the product rationale behind backlog decisions.
...
| [Market References](market-references.md) | Record external benchmarks, the lessons considered, and the boundaries that protect DatumLex's independent identity. |
